            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">
                            {{ $users->filter(fn($user) => $user->hasRole('admin'))->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">ID: {{ substr($user->id, 0, 8) }}...
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        @if ($user->id !== auth()->id())
                                            <button
                                                ...
                                                <i
                                                    class="fas {{ $user->is_active ? 'fa-pause' : 'fa-play' }} mr-2"></i>
                                            </button>
                                        @endif
                                        ...
                                        @if ($user->id !== auth()->id())
                                            <button
                                                onclick="konfirmasiHapus('{{ route('users.destroy', $user->id) }}', '{{ $user->name }}', 'Hapus User', 'User yang dihapus tidak dapat dikembalikan!')"
                            ...
                            <tr>
                                <td colspan="8" class="px-6 py-12 text-center">
                                    <div class="text-gray-500">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan pengguna baru.
                                        </p>
                                        <div class="mt-6">
                                            <a href="{{ route('users.create') }}"
                                                class="inline-flex items-center px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded-lg transition-colors duration-200">
