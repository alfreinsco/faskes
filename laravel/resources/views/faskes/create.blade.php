...
<x-layouts.app>
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah {{ $moduleName }} Baru</h1>
                <p class="text-gray-600">Tambahkan {{ strtolower($moduleName) }} baru ke sistem</p>
            </div>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <form action="{{ route($moduleType . '.store') }}" method="POST" enctype="multipart/form-data"
                class="p-6 space-y-6">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text font-medium">Nama Faskes <span class="text-red-500">*</span></span>
                        </label>
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="alamat" rows="3"
                            ...
                            placeholder="Masukkan alamat lengkap faskes">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <label class="label">
                                <span class="label-text-alt text-red-500">{{ $message }}</span>
                            </label>
                ...
                <div class="space-y-4">
                    ...
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text font-medium">Gambar Faskes</span>
                        </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-control">
                            ...
                            <input type="time" name="waktu_buka" value="{{ old('waktu_buka') }}"
                        ...
                        <div class="form-control">
                            ...
                            <input type="time" name="waktu_tutup" value="{{ old('waktu_tutup') }}"
